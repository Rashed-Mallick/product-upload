...
$sqlTot = 'select * from product_details where 1';
$resTot = mysqli_query($conn,$sqlTot);
$numTot = mysqli_num_rows($resTot);
                ...
                <div class="card card-grey">
                    <div class="card-header"><?php echo $_SESSION['msg']; unset($_SESSION['msg']); ?><?php echo $msg; ?>
                        <div class="d-flex align-items-center">
                            ...
                            <a href="add.php" class="btn btn-success btn-round ml-auto">
                            ...
                            <table id="add-row" class="display table table-striped table-hover table-head-bg-info" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        	<?php if($file!='assets/img/empty.png'){ ?><a class="imgthumb" href="assets/upload/<?php echo $rowF['img_images']; ?>"><span class="badge badge-secondary"><?php echo $rowN; ?></span><img src="<?php echo $file; ?>" width="40"></a><?php } ?>
                                        </td>
                                        <td>
                                            <div class="form-button-action">
                                                <a href="edit.php?id=<?php echo $row['prod_id']; ?>" data-toggle="tooltip" title="" class="btn-link btn-primary mr-3" data-original-title="Edit Order">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                
                                                <a href="javascript:void(0)" onclick="delRecord(<?php echo $row['prod_id']; ?>,'<?php echo $row['prod_relation']; ?>')" data-toggle="tooltip" title="" class="btn-link btn-danger" data-original-title="Remove">
